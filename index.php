...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['type_participant'])) {
        ...
        // Sanitize values received with allowed list
        $allowed = ['etudiant', 'professionnel', 'speaker'];
                        ...
                        <fieldset>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type_participant"
                                    id="optionsRadiosEtudiant" value="etudiant" <?php if ($type_participant === 'etudiant')
                                        echo 'checked=""'; ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type_participant"
                                    id="optionsRadiosProfessionnel" value="professionnel" <?php if ($type_participant === 'professionnel')
                                        echo 'checked=""'; ?>>
